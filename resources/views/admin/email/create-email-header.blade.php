      ...
      <section class="section-container">
        ...
        <div class="content-wrapper">
          ...
          <div class="card card-default">
             <div class="card-header"> @if(isset($data)){{'Edit Email Header'}}@else{{'Add Email Header'}}@endif
               <a href="{{route('admin.email_header_template')}}" class="btn btn-danger f-right"><i class="fa fa-arrow-left"></i> Back</a>
             </div>
             <div class="card-body">
                <form method="POST" name="email_header_template" id="email_header_template" action="{{url('admin/email_header_template/action/')}}/{{$view}}/{{isset($data->id) ? $data->id: '0'}}">
...
<script type="text/javascript">
   $(function() {
      $("#email_header_template").validate({
        ignore: ".ignore",
         rules: {
            title: {
               required: true,
