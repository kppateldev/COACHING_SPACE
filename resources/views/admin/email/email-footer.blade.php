        ...
        <div class="content-wrapper">
          ...
          <div class="card card-default">
             <div class="card-header">Listings
               <a href="{{route('admin.email_footer_template.add')}}" class="btn btn-primary f-right"><i class="fa fa-plus"></i> Add</a>
             </div>
             <div class="card-body">
               <table class="table table-striped my-4 w-100" id="email_footer_templateTbl">
                  <thead>
                     <tr>
                        <th>ID</th>
                        <th>Title</th>
                  ...
                  <tbody>
                     ...
                     <tr class="gradeU">
                        ...
                        <td>{{$val->title}}</td>
                        <td>
                          <a href="{{route('admin.email_footer_template.edit',$val->id)}}" class="btn btn-primary" title="Edit"><i class="fa fa-edit"></i></a>
                        </td>
                     </tr>
                     @endforeach
                  </tbody>
