      ...
      <section class="section-container">
        ...
        <div class="content-wrapper">
          ...
          <div class="card card-default">
             <div class="card-header"> @if(isset($data)){{'Edit Department'}}@else{{'Add Department'}}@endif
               <a href="{{route('admin.departments')}}" class="btn btn-danger f-right"><i class="fa fa-arrow-left"></i> Back</a>
             </div>
             <div class="card-body">
                <form id="departments-form" class="form-horizontal ajax_form" method="post" action="@if(isset($data)){{route('admin.departments.update',$data->id)}}@else{{route('admin.departments.store')}}@endif">
                  ...
                  <div class="alert ajax_report alert-info alert-hide" role="alert">
                   ...
                   <fieldset>
                      <div class="form-group row mb-2">
                         <label class="col-md-2 col-form-label">Department Title <span class="red">*</span></label>
                         <div class="col-md-10">
                   ...
                   <fieldset>
                      <div class="text-right mt-3">
                           <a href="{{route('admin.departments')}}" class="btn btn-warning">Discard</a>
