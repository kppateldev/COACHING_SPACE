        ...
        <div class="content-wrapper">
          ...
          <div class="card card-default">
             <div class="card-header">Listings
               <a href="{{route('admin.departments.create')}}" class="btn btn-info f-right"><i class="fa fa-plus"></i> Add</a>
             </div>
             <div class="card-body">


               <table class="table table-striped my-4 w-100" id="departmentsTbl">
                  <thead>
                     <tr>
                        <th>Department ID</th>
                  ...
                  <tbody>
                     ...
                     <tr class="gradeU">
                        ...
                        <td>{{$val->title}}</td>
                        <td>
                          <a href="{{route('admin.departments.edit',$val->id)}}" class="btn btn-primary" title="Edit"><i class="fa fa-edit"></i></a>
                          <button data-url="{{route('admin.departments.delete',$val->id)}}" data-toggle="modal" data-target="#deleteModal" class="btn btn-danger" title="Delete"><i class="fa fa-trash"></i></button>
                        </td>
                     </tr>
                     @endforeach
                  </tbody>
...
$(document).ready(function() {
    var table = $('#departmentsTbl').DataTable({
