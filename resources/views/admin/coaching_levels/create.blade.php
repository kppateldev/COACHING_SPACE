      ...
      <section class="section-container">
        ...
        <div class="content-wrapper">
          ...
          <div class="card card-default">
             <div class="card-header"> @if(isset($data)){{'Edit Coaching Level'}}@else{{'Add Coaching Level'}}@endif
               <a href="{{route('admin.coaching_levels')}}" class="btn btn-danger f-right"><i class="fa fa-arrow-left"></i> Back</a>
             </div>
             <div class="card-body">
                <form id="coaching_levels-form" class="form-horizontal ajax_form" method="post" action="@if(isset($data)){{route('admin.coaching_levels.update',$data->id)}}@else{{route('admin.coaching_levels.store')}}@endif">
                  ...
                  <div class="alert ajax_report alert-info alert-hide" role="alert">
                   ...
                   <fieldset>
                      <div class="form-group row mb-2">
                         <label class="col-md-2 col-form-label">Coaching Level Title <span class="red">*</span></label>
                         <div class="col-md-10">
                   ...
                   <fieldset>
                      <div class="text-right mt-3">
                           <a href="{{route('admin.coaching_levels')}}" class="btn btn-warning">Discard</a>
